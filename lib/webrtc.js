...
class WebRTC {
  ...
  constructor(userWebId, userInboxUrl, opponentWebId, opponentInboxUrl, fetch, initiator = true, onNewData, onCompletion) {
    this.initiator = initiator;
    // we use different fetchers, because we don't want to share the cache
    this.inboxFetcherForAnswers = new InboxFetcher(userInboxUrl, fetch);
    this.inboxFetcherForOffers = new InboxFetcher(userInboxUrl, fetch);
    this.inboxFetcherForICECandidates = new InboxFetcher(userInboxUrl, fetch);
